# from https://github.com/dokyeongK/yolo-v2_pytorch/blob/19b236aa7b0b175aea7ceeb48910bc52cf721bd4/dataset/transform.py
import os
import torch
import numpy as np
...
class COCO_Dataset(Dataset):
    ...
    def __init__(self, root_dir='/data/datasets/coco', set_name='val2017', mode='TRAIN'):
