...
class PIDLateralController():
    ...
    def run_step(self, target_transform):
        """
        ...
        """
        return self._pid_control(target_transform, self._vehicle.get_transform())

    def _pid_control(self, target_transform, vehicle_transform):
        """
