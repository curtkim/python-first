...
def draw_road_map(map_surface, actors, carla_map, world_to_pixel, world_to_pixel_width,
                  show_triggers, show_spawn_points, show_connections):
    ...
    def draw_traffic_signs(surface, font_surface, actor, color=COLOR_ALUMINIUM_2, trigger_color=COLOR_PLUM_0):
        ...
        if show_triggers:
            corners = get_bounding_box(actor)
...
class MapImage(object):
    ...
    def __init__(self, carla_map, actors, pixels_per_meter, show_triggers, show_connections, show_spawn_points):
        ...
        filename = carla_map.name + "_" + opendrive_hash + ".png"
